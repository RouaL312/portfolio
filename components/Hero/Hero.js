    ...
    >
      ...
      <div className="flex flex-col pt-40 md:pt-0 select-none">
        ...
        <h1 className={`${styles.heroName} text-white text-6xl font-semibold`}>
          <span className={`relative ${styles.emphasize} seq`}>Roua</span>
          <span className="seq"> Laadouz</span>
        </h1>
        <p>
          <span
            ref={typedEl}
        ...
        <div className="seq pt-4 " >
          { <Button 
            ...
            href="https://www.linkedin.com/in/roua-laadouz/details/featured/1635551390924/single-media-viewer/?profileId=ACoAACZ8nz0B1LjtciqooRcMoMIolsWg3U9jT0E"
          >
            Resume
          </Button> }
      ...
      <div className={styles.background__gif}></div>
